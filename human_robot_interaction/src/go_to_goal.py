...
class Husky:
    ...
    def callback(self, data):
        ...
        dist = self.euclidean_distance(self.human_pose)
        ...
        if(dist < 3):
            ...
            self.goals_X = [self.human_pose.x - 3,   self.human_pose.x - 2,       self.human_pose.x,          self.human_pose.x + 2,     self.human_pose.x + 3]
            self.goals_Y = [self.human_pose.y,       self.human_pose.y - 2,       self.human_pose.y - 3,      self.human_pose.y - 2,     self.human_pose.y - 0.5]
    ...
    def move2goal(self):
        ...
        print("flag = ", self.waypoints_flag)
        
        if(self.waypoints_flag == 1):
            ...
            for i in range( len(self.goals_X) ):
                ...
                if(self.euclidean_distance(goal_pose)) > 3:
